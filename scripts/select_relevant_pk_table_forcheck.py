...
with jsonlines.open("../data/cell_entities/parsed_val_ner_entities.jsonl") as reader:
    json_list = []
    for obj in reader:
        json_list.append(obj)

with open('../data/relevant_ids/parsed_val_ner__ids_distilbert.txt', 'r') as readfile:
...
with jsonlines.open("../data/pk_tablesclass_data/relevant/" + "parsed_val_ner__relevant_forclass.jsonl", mode='w') as writer:
