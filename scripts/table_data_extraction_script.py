...
# read in json file
with jsonlines.open("../data/json/split_pk_pmcs_ner_dec2021/train_ner_2000.jsonl") as reader:
    json_list = []
    for obj in reader:
...
pkl_file_name = "table_hashes_train_ner_2000.pkl"
parsed_table_dict_list = parse_xml_tables(json_list, pkl_file_name)

# save as jsonl file
with jsonlines.open("../data/json/parsed_pk_pmcs_ner_dec2021/" + "parsed_train_ner_2000.jsonl", mode='w') as writer:
